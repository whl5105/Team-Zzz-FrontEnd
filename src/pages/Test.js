...
const Test = (props) => {
  ...
  function search() {
    ...
    const wakeuptime = hour * 60 + minute - 540;
    setwakeup_time(hour * 60 + minute - 540)
    ...
    console.log(setTime)
    var res4 = new Date(setTime.getTime() - 270*60000);
    var res3 = new Date(res4.getTime() - 90*60000);
		var res2 = new Date(res3.getTime() - 90*60000);
		var res1 = new Date(res2.getTime() - 90*60000);    // 요걸 오전 오후로 계산해서 할것 밥먹고와서 
    // console.log(res4.getHours(), res4.getMinutes())
    // console.log(res3.getHours(), res3.getMinutes())
    // console.log(res2.getHours(), res2.getMinutes())
    // console.log(res1.getHours(), res1.getMinutes())
    // console.log(res1.getHours(), res2.getHours(), res3.getHours(), res4.getHours())
...
if(date==='오후'){
  let restime1 = res1.getHours()
    ...
    //     if (date === "오전") {
    //       setampm("오후");
    //       setwakeup_hour(12 + Math.floor(wakeuptime / 60));
    //       setwakeup_min((wakeuptime % 60) + 60);
    //       // console.log(ampm, wakeup_hour, wakeup_min);
    //       // return console.log(`잘시간: ${wakeuphour}`, wakeupmin);
    //     } else {
    //       setampm("오전");
    //       setwakeup_hour(12 + Math.floor(wakeuptime / 60));
    //       setwakeup_min((wakeuptime % 60) + 60);
    ...
    //       setampm("오후");
    //       setwakeup_hour(12 + Math.floor(wakeuptime / 60));
    //       setwakeup_min((wakeuptime % 60) / -1);
    //       // console.log(`잘시간: ${wakeuphour}`,wakeupmin);
    //       // console.log(ampm, wakeup_hour, wakeup_min);
    //     }
    //     else{
    //       setampm("오전");
    ...
    // else{
    //   if(wakeuptime===0 && date === '오후')
    //   {
    //     setampm(date);
    //     setwakeup_hour(12);
    //     setwakeup_min((wakeuptime % 60));
        
    //     // console.log(ampm, wakeup_hour, wakeup_min)
    //   }
    // else{
    //   setampm(date);
    //   setwakeup_hour(Math.floor(wakeuptime / 60));
    //   setwakeup_min((wakeuptime % 60));
    ...
    // console.log(Math.floor(wakeuptime/60),wakeuptime%60 );
    // console.log(date);
    // console.log(hour);
    // console.log(minute);
  }
  return (
    <React.Fragment>
      ...
      {/* <input style={{width: "20px", margin: "5px"}}></input> */}
      {/* <input style={{width: "20px", margin: "5px"}}></input> */}
      <input
        type="button"
        value="계산하기"
